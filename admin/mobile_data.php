...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-mobile"></i> Insert Mobile
                            </li>
                        </ol>
                    </div>
                </div>
		...
		<form name="m" action="mobile_code.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			<td>SIM Type</td>
			<td><input type="text" name="sim" size="30" class="txt" /></td>
		</tr> 
		<tr>
			<td>Network Type</td>
			<td><input type="text" name="network" size="30" class="txt" /></td>
		</tr>       
        <tr>
			<td>Weight</td>
		...
		<tr>
			...
			<td><input type="text" name="pcamera" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Secondary Camera</td>
			<td><input type="text" name="scamera" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Display</td>
			<td><input type="text" name="screen" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Processor</td>
		...
		<tr>
			...
			<td><input type="text" name="storage" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Bluetooth</td>
		...
		<tr>
			<td>Wi-Fi Hotspot</td>
			<td><input type="radio" name="hspot" value="Yes" />Yes &nbsp;&nbsp;<input type="radio" name="hspot" value="No" />No</td>
		</tr>
		<tr>
			<td>Wi-Fi Version</td>
			<td><input type="text" name="ver" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Touch Screen</td>
			<td><input type="radio" name="touch_screen" value="Yes" />Yes &nbsp;&nbsp;<input type="radio" name="touch_screen" value="No" />No</td>
		</tr>
		<tr>
			<td>Power & Battary</td>
        ...
        <tr>
			<td>Audio Format</td>
			<td><input type="text" name="audio" size="30" class="txt" /></td>
		</tr>
        <tr>
			<td>Video Format</td>
			<td><input type="text" name="video" size="30" class="txt" /></td>
		</tr>
		<tr>
			<td>Image</td>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="ok" value="Insert Mobile Data" class="bt" /></td>
		</tr>
		</table>
		</form>
