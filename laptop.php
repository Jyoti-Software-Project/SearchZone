...
<div class="container-fluid d-flex justify-content-center">
    ...
    <?php
			...
			if(isset($_POST['ok']))
			{
				...
				if($company=="nothing")
				{
					echo "<script>alert('Please select any Brand !'); location.href='laptop.php';</script>";
				}
				else
				{
				$sr="SELECT * FROM `laptop` WHERE `company`='$company'";
				$r=mysql_query($sr);
            ...
            <div class="card"> <center><img src="<?php echo 'admin/'.$m_row['imgurl']; ?>" width="" height="150" class="card-img-top"></center>
                <div class="card-body pt-0 px-0">
                    ...
                    <div class="mx-3 mt-3 mb-2">
                    	<a href="laptop_details_view.php?id=<?php echo $m_row['id']; ?>">
        ...
        <?php }	} } else { 
        	$sr="SELECT * FROM `laptop` ORDER BY `id` DESC";
				$r=mysql_query($sr);
				while($m_row=mysql_fetch_array($r))
				{
