...
<?php
        ...
        $search="SELECT * FROM `mobile` WHERE `id`='$get_id'";
...
<head>
    ...
    <title>Mobile Details View</title>
		  	...
		  	<div class="row">
		  		<div class="col-lg-4">
		    		<div class="navbar-header">
		      			<a class="navbar-brand" href="mobile.php" style="font-size: 40px; padding-top: 25px; font-family: Cursive;">S e a r c h Z o n e</a>
		    		</div>
		    	</div>
			</div>
		  </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div style="width:100%;border-top:1px solid silver">
                            ...
                            <tr>
                                ...
                                <td ><?php echo $row['pcamera']; ?></td>
                            </tr>
                            <tr>
                                <td >Secondary Camera </td>
                                <td ><?php echo $row['scamera']; ?></td>
                            </tr>
                            <tr>
                                <td >Display </td>
                            ...
                            <tr>
                                <td >Touch Screen: </td>
                                <td ><?php echo $row['touch_screen']; ?></td>
                            </tr>
                            <tr>
                                <td >Battary: </td>
